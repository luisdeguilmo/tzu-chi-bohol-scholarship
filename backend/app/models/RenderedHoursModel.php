...
class RenderedHoursModel {
    ...
    public function recordHours($accountId) {
        $communityServiceRenderedHours = $this->getScholarCommunityServiceRenderedHoursById($accountId);
    ...
    public function recordCommunityServiceRenderedHours($accountId, $renderedHours) {
        ...
        $query = "UPDATE " . $this->table_name . " SET community_service_rendered_hours = :rendered_hours WHERE account_id = :account_id";
    ...
    public function recordEventRenderedHours($accountId, $renderedHours) {
        ...
        $query = "UPDATE " . $this->table_name . " SET event_rendered_hours = :rendered_hours WHERE account_id = :account_id";
    ...
    public function AttendedEvents($accountId) {
        ...
        $query = "UPDATE " . $this->table_name . " SET attended_events = :attended_events WHERE account_id = :account_id";
    ...
    public function getScholarCommunityServiceRenderedHoursById($account_id) {
        $query = "SELECT community_service_rendered_hours FROM " . $this->table_name . " WHERE account_id = :account_id";
    ...
    public function getScholarEventRenderedHoursById($account_id) {
        $query = "SELECT event_rendered_hours FROM " . $this->table_name . " WHERE account_id = :account_id";
    ...
    public function getScholarAttendedEventsById($account_id) {
        $query = "SELECT attended_events FROM " . $this->table_name . " WHERE account_id = :account_id";
