...
class ScholarDashboardDataModel {
    ...
    public function getNumberOfCommunityServices($id) {
        $query = "SELECT COUNT(*) AS community_service_count FROM volunteer_activities WHERE activity_date >= :start_of_month AND activity_date < :start_of_next_month AND account_id = :account_id";
