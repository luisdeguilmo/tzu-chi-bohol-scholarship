...
class ActivityService {
    ...
    public function updateActivityWithFiles($activityData, $existingFiles = [], $removedExistingFiles = [], $files = null, $base64Files = null) {
        $batch_id = $this->generateBatchId();
        // Validate activity data
        $this->validateActivityData($activityData);
        ...
        if (!$this->certificateModel->deleteCOA($activityData['activity_id'], $activityData['batch_id'])) {
