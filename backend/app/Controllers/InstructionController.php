        ...
        try {
            ...
            if (
                !$this->auditLogModel->create([
                    ...
                    'user_role' => 'staff',
                    'action' => Action::INSTRUCTION_CREATE,
                    ...
                    'old_values' => null,
                    'new_values' => ['instruction' => $data['instruction']],
        ...
        try {
            ...
            if (
                !$this->auditLogModel->create([
                    ...
                    'actor' => "{$staff['first_name']} {$staff['last_name']}",
                    'user_role' => 'staff',
                    'action' => Action::INSTRUCTION_UPDATE,
                    'entity_type' => 'criteria',
                    'entity_id' => null,
                    ...
                    'description' =>
                        ...
                        ' ' .
                        $staff['last_name'] .
                        ' updated an instruction.',

                    'old_values' => null,
                    'new_values' => ['instruction' => $data['instruction']['instruction']],
                    'ip_address' => $_SERVER['REMOTE_ADDR'] ?? null,
                    'user_agent' => $_SERVER['HTTP_USER_AGENT'] ?? null,
                ])
            ) {
        ...
        try {
            ...
            if (
                !$this->auditLogModel->create([
                    ...
                    'actor' => "{$staff['first_name']} {$staff['last_name']}",
                    'user_role' => 'staff',
                    'action' => Action::INSTRUCTION_DELETE,
                    'entity_type' => 'criteria',
                    'entity_id' => null,
