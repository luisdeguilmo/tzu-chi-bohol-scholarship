...
const LoginForm = ({ role }) => {
    ...
    return (
        <div className="hero flex items-center justify-center min-h-screen">
            ...
            <div className="bg-white px-6 py-10 rounded-md shadow-lg absolute z-30 top-[75%] md:top-[70%] left-[50%] translate-x-[-50%] translate-y-[-100%] w-[90%] sm:max-w-[400px] border border-gray-200">
