...
//     const from = location.state?.from?.pathname || getDefaultDestination(role, user);
...
//             console.log("Login attempt:", { email: data.email, type: data.type });
...
//                 // Use the auth context login method (no token needed)
//                 await login(result.user);
//                     await login(result.token, result.user);

//                 toast.success("Login successful!");

//                 const destination = from || getDefaultDestination(role, result.user);
//                 navigate(destination, { replace: true });
//                 console.log("Navigating to:", destination);
//             } else {
//                 setError(
...
//     const handleSendResetLink = async (e) => {
//         e.preventDefault();
//         console.log("Sending reset link for:", email);
...
//                 setIsEmailSent(true);
//             } else {
//                 console.log("Reset link error:", result);
//                 setError(result.message || "Failed to send reset link.");
//             }
...
//                 <form
//                     onSubmit={isResetPassword ? handleSendResetLink : handleLogin}
//                     className="space-y-4"
//                 >
//                     {isEmailSent && isResetPassword ? (
//                         <p className="mt-4 p-4 text-green-700 bg-green-100 border border-green-300 rounded-md text-sm flex items-start gap-2">
...
//             <div className="bg-white p-10 sm:rounded-md shadow-lg absolute z-30 top-[75%] md:top-[70%] left-[50%] translate-x-[-50%] translate-y-[-100%] w-[100%] sm:max-w-[400px] border border-gray-200">
//                 <div className="text-center mb-4">
//                     <h2 className="text-2xl font-bold text-gray-800">
//                         {isResetPassword
//                             ? "Forgot Password"
