...
//                                 <div
//                                     className={`fixed top-32 left-0 right-0 bottom-0 bg-black/20 transition-opacity duration-500 pointer-events-auto ${isAnimating ? "opacity-100" : "opacity-0"}`}
//                                     onClick={toggleMobileMenu}
//                                 ></div>

//                                 <div className="fixed border-t-2 border-green-600 top-24 left-[50%] translate-x-[-50%] w-[80%] z-50 pointer-events-auto">
//                                     <div
//                                         className={`
//                                                         bg-white shadow-2xl overflow-hidden
//                                                         transition-all duration-1000
//                                                         ${isAnimating ? "max-h-[80vh] opacity-100" : "max-h-0 opacity-0"}
//                                                     `}
//                                     >
//                                         {/* content */}
...
//                             {/* Menu panel */}
//                             <div className="fixed top-24 left-[50%] translate-x-[-50%] w-[80%] z-50">
//                                 <div
//                                     className={` border-t-2 border-green-600
//                                         bg-white shadow-2xl overflow-hidden
