...
//                                         <h3 className="mb-2 text-xs text-gray-600 font-bold">
//                                             Rendered Hours:
//                                         </h3>
//                                         <div
    ...
    ({
        ...
        useEffect(() => {
            if (method === "automatic") {
                ...
                const endTime = convertTo24HourFormat(localEvent?.end_time).split(
                    ":"
                );
                const renderedHours = endTime[0] - startTime[0];
                setRenderedHours(renderedHours);
            ...
            <>
                ...
                >
                    ...
                    <div className="flex justify-end rounded-b-sm gap-2 p-3.5 border-t border-gray-300 bg-gray-50 flex-shrink-0">
                        ...
                        {isScholar &&
                            date.getCurrentDateAndTime() <
                                localEvent?.date + " " + localEvent?.start_time && (
                                <EventButton
                                    numberOfParticipants={
                                        localEvent?.numberOfParticipants
                                    }
                                    participantLimit={localEvent?.participant_limit}
                                    hasJoinButton={
