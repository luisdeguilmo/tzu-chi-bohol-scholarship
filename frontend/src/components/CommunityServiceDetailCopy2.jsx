                    ...
                    >
                        <div className="relative w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl bg-white rounded-xl shadow-2xl overflow-hidden transform animate-in zoom-in-95 duration-200">
                            ...
                            <form
                                ...
                                className="max-h-[500px] overflow-y-auto scroll-smooth p-6 space-y-6"
                            >
                                {/* Event Details Grid */}
                                ...
                                >
                                    ...
                                    <p className="mb-2 text-xs font-bold italic text-gray-600">
                                        Note:{" "}
                                        <span className="font-normal">
                                            Hours will only be recorded if you
                                    ...
                                    <label className="block mb-1 text-gray-600 font-bold text-xs">
                                        Feedback{" "}
                                        <span className="font-normal">
                                            (Optional for approval, required for
                                            rejection)
                                        </span>
                                    </label>
                                    <textarea
