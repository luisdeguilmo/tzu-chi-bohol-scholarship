...
const Courses = ({ label }) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                const updatedCourses = courses.map((item) =>
                    item.id === id ? { ...item, course_name: newText } : item
                );
    ...
    const handleDelete = async (id, length) => {
        try {
            // Make the API call to delete
            await axios.delete(
                `http://localhost:8000/app/views/courses.php?id=${id}`
            );
    ...
    return (
        <div className="bg-white rounded-md shadow-md p-6">
            ...
            <div className="overflow-x-auto rounded-sm border border-gray-200">
                ...
                {/* DeleteModal - Single instance outside the map function */}
                <DeleteModal
            ...
            <div className="flex justify-between items-center mt-6">
                <FormModal
                    ...
                    label={label}
                    fields={scholarshipCriteriaInputFields.courseInputField}
                />
