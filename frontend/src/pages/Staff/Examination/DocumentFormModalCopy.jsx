...
function DocumentFormModal({ isOpen, setIsOpen, selectedId }) {
    const { applicationFiles } = useApplicationFiles("entrance_examination", selectedId);
