...
import NewApprovedApplications from "./NewApprovedApplications";
import RenewalApprovedApplications from "./RenewalApprovedApplications";
...
const ApprovedApplicationsPage = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="py-6">
                {activeTab === "newApplications" && <NewApprovedApplications />}
                {activeTab === "renewalApplications" && <RenewalApprovedApplications />}
            </div>
        </div>
    );
};
